...
client.on("ready", async () => {
 ...
 let status = [`a!help • ${client.guilds.cache.size.toLocaleString()} Servers`, `/help • ${client.guilds.cache.size.toLocaleString()} Servers`, `https://t.ly/atlantean`, `a!vote • ${client.guilds.cache.size.toLocaleString()} Servers`, "Slash commands! RE-INVITE ME!"]
